...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname seizure.2) (read-case-sensitive #t) (teachpacks ((lib "universe.ss" "teachpack" "2htdp") (lib "picturing-programs.rkt" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.ss" "teachpack" "2htdp") (lib "picturing-programs.rkt" "installed-teachpacks")))))
