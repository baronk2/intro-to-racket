...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname webs_gradientcircle) (read-case-sensitive #t) (teachpacks ((lib "image.ss" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.ss" "teachpack" "2htdp")))))
(define x 200)
(define y 400)
(define z (/ (* x (sqrt 3)) 2))
